...
const createPost = async (event) =>{
    ...
    if (comment) {
        ...
        if (!response.ok) {
            showModal('Error','Error creating comment, please check your details and try again.');
            return;
        }
        ...
        showModal('Incomplete details','Please complete the comment data and press Create button.');
    }
}
